...
public class ExpectedBlockHasProposer implements Condition {
  ...
  private Address proposerAddress(final Node node) {
    ...
    final BlockHeader blockHeader =
        BlockUtils.createBlockHeader(block, new RepuBlockHeaderFunctions());
    final RepuExtraData repuExtraData = RepuExtraData.decode(blockHeader);
    return repuExtraData.getProposerAddress();
  }
}
