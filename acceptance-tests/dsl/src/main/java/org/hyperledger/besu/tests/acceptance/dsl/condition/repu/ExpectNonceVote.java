...
import static org.hyperledger.besu.tests.acceptance.dsl.condition.repu.ExpectNonceVote.REPU_NONCE_VOTE.AUTH;
...
public class ExpectNonceVote implements Condition {
  ...
  public enum REPU_NONCE_VOTE {
    AUTH,
    DROP
  }

  public ExpectNonceVote(final EthTransactions eth, final REPU_NONCE_VOTE vote) {
    this.eth = eth;
