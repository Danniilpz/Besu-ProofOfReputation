...
public class RepuMiningAcceptanceTest extends AcceptanceTestBase {
  ...
  public void shouldStallMiningWhenInsufficientValidators() throws IOException {
    ...
    minerNode1.verify(repu.blockIsCreatedByProposer(minerNode1));

    minerNode1.verify(repu.noNewBlockCreated(minerNode1));
  }
  ...
  public void shouldStillMineWhenANodeFailsAndHasSufficientValidators() throws IOException {
    ...
    cluster.verifyOnActiveNodes(repu.blockIsCreatedByProposer(minerNode1));
    cluster.verifyOnActiveNodes(repu.blockIsCreatedByProposer(minerNode2));
  }
}
