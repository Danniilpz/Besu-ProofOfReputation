...
public enum RpcMethod {
  ...
  REPU_DISCARD("repu_discard"),
  REPU_GET_SIGNERS("repu_getSigners"),
  REPU_GET_SIGNERS_AT_HASH("repu_getSignersAtHash"),
  REPU_GET_PROPOSALS("repu_proposals"),
  REPU_PROPOSE("repu_propose"),
  REPU_GET_SIGNER_METRICS("repu_getSignerMetrics"),
