...
public class RepuQueryPluginServiceFactory implements PluginServiceFactory {

  private final Blockchain blockchain;
  private final NodeKey nodeKey;

  public RepuQueryPluginServiceFactory(final Blockchain blockchain, final NodeKey nodeKey) {
