...
public class RepuDifficultyCalculator implements DifficultyCalculator {
  ...
  public RepuDifficultyCalculator(final Address localAddress) {
  ...
  public BigInteger nextDifficulty(
    ...
    final Address nextProposer =
        RepuHelpers.getValidatorForBlockAfter(parent);
