...
import org.hyperledger.besu.consensus.repu.RepuDifficultyCalculator;
...
public class RepuDifficultyValidationRule implements AttachedBlockHeaderValidationRule {

  private static final Logger LOG = LoggerFactory.getLogger(RepuDifficultyValidationRule.class);
