...
public class BlockHeaderValidationRulesetFactory {
   ...
   *
   * <p>Specifically the set of rules provided by this function are to be used for a Repu chain.
   *
   ...
   */
  public static BlockHeaderValidator.Builder repuBlockHeaderValidator(
      final long secondsBetweenBlocks,
      final EpochManager epochManager,
      final Optional<BaseFeeMarket> baseFeeMarket) {
    return repuBlockHeaderValidator(
