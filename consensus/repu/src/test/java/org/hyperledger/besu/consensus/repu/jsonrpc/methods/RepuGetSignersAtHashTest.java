...
public class RepuGetSignersAtHashTest {

  private RepuGetSignersAtHash method;
  ...
  public void returnsMethodName() {
    assertThat(method.getName()).isEqualTo("repu_getSignersAtHash");
  }
  ...
  public void failsWhenNoParam() {
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(
            new JsonRpcRequest("2.0", "repu_getSignersAtHash", new Object[] {}));
  ...
  public void returnsValidatorsForBlockHash() {
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(
            new JsonRpcRequest("2.0", "repu_getSignersAtHash", new Object[] {BLOCK_HASH}));
  ...
  public void failsOnInvalidBlockHash() {
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(
            new JsonRpcRequest("2.0", "repu_getSigners", new Object[] {BLOCK_HASH}));
