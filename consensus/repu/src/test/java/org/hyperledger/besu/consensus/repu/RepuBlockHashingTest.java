...
public class RepuBlockHashingTest {

  private BlockHeader expectedHeader = null;

  // repu.getSignersAtHash("0x8b27a29300811af926039b90288d3d384dcb55931049c17c4f762e45c116776e")
  ...
  public void recoverProposerAddressFromSeal() {
    final RepuExtraData repuExtraData = RepuExtraData.decode(expectedHeader);
    final Address proposerAddress =
        RepuBlockHashing.recoverProposerAddress(expectedHeader, repuExtraData);
  ...
  public void recoverProposerAddressForGenesisBlockReturnsAddressZero() {
    ...
    final RepuExtraData repuExtraData = RepuExtraData.decode(genesisBlockHeader);
    final Address proposerAddress =
        RepuBlockHashing.recoverProposerAddress(genesisBlockHeader, repuExtraData);
  ...
  public void readValidatorListFromExtraData() {
    final RepuExtraData repuExtraData = RepuExtraData.decode(expectedHeader);
    assertThat(repuExtraData.getValidators()).isEqualTo(VALIDATORS_IN_HEADER);
  }
  ...
  private BlockHeader createKnownHeaderFromCapturedData() {
    ...
    builder.blockHeaderFunctions(new RepuBlockHeaderFunctions());
