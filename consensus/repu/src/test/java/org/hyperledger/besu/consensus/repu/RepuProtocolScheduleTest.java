...
public class RepuProtocolScheduleTest {
  ...
  public void protocolSpecsAreCreatedAtBlockDefinedInJson() {
    ...
    final ProtocolSchedule protocolSchedule =
        RepuProtocolSchedule.create(config, NODE_KEY, false, EvmConfiguration.DEFAULT);
  ...
  public void parametersAlignWithMainnetWithAdjustments() {
    ...
    assertThat(homestead.getDifficultyCalculator()).isInstanceOf(RepuDifficultyCalculator.class);
  }

  @Test
  public void zeroEpochLengthThrowsException() {
    final RepuConfigOptions repuOptions = mock(RepuConfigOptions.class);
    when(repuOptions.getEpochLength()).thenReturn(0L);
    when(genesisConfig.getRepuConfigOptions()).thenReturn(repuOptions);
  ...
  public void negativeEpochLengthThrowsException() {
    final RepuConfigOptions repuOptions = mock(RepuConfigOptions.class);
    when(repuOptions.getEpochLength()).thenReturn(-3000L);
    when(genesisConfig.getRepuConfigOptions()).thenReturn(repuOptions);
