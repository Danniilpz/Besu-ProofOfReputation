...
public class RepuProposalsTest extends AbstractVoteProposerMethodTest {

  private RepuProposals method;
  ...
  protected String getMethodName() {
    return "repu_proposals";
  }

  @Before
  public void setup() {
    method = new RepuProposals(getValidatorProvider());
  }
