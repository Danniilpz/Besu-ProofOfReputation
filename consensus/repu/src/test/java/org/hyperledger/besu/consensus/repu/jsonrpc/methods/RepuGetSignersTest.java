...
public class RepuGetSignersTest {
  private RepuGetSigners method;
  ...
  @Before
  public void setup() {
    method = new RepuGetSigners(blockchainQueries, validatorProvider);
  ...
  public void returnsMethodName() {
    assertThat(method.getName()).isEqualTo("repu_getSigners");
  }
  ...
  public void returnsValidatorsForBlockNumber() {
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(
            new JsonRpcRequest("2.0", "repu_getSigners", new Object[] {"0x2EC88B"}));
  ...
  public void failsOnInvalidBlockNumber() {
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(
            new JsonRpcRequest("2.0", "repu_getSigners", new Object[] {"0x1234"}));
