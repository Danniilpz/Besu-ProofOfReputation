...
public class RepuBlockInterfaceTest {
  ...
  private final BlockHeaderTestFixture headerBuilder =
      new BlockHeaderTestFixture().blockHeaderFunctions(new RepuBlockHeaderFunctions());

  private final BlockHeader header =
      TestHelpers.createRepuSignedBlockHeader(headerBuilder, proposerKeys, validatorList);
  ...
  public void blendingAddVoteToHeaderResultsInHeaderWithNonceOfMaxLong() {
    ...
    final BlockHeaderBuilder builderWithVote =
        RepuBlockInterface.createHeaderBuilderWithVoteHeaders(builder, Optional.of(vote));
  ...
  public void nonVoteBlendedIntoHeaderResultsInACoinbaseOfZero() {
    final BlockHeaderBuilder builderWithVote =
        RepuBlockInterface.createHeaderBuilderWithVoteHeaders(builder, Optional.empty());
